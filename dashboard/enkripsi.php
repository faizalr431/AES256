        ...
        <div class="left-sidebar-pro">
            <nav id="sidebar" class="">
                ...
                <div class="nalika-profile">
                    ...
                    <a href="#"><img style="height:50px" src="img/Faizal.png" alt="" /></a>
                ...
                <form class="form-horizontal" method="post" action="encrypt-process.php" enctype="multipart/form-data">
                      <fieldset>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-lg-4">
                            <input class="form-control" id="inputPassword" type="password" placeholder="Password" minlength = "6" maxlength = "16" name="pwdfile" required>
                          </div>
                        </div>
                        <div class="form-group">
